...
impl ErrorMessage {
    fn to_str(&self) -> String {
        match self {
            ...
            ErrorMessage::PasswordTooShort(length) => {
                format!("Password too short: {} characters", length)
            }
            ...
            } // ErrorMessage::UserNotAuthorized => "You are not authorized to perform this action".to_string(),
        }
    }
}
